...
input_folder = input("Enter the path of the input folder containing .nc files without quotes - ") 

shape_file_path = input("Enter the path of the shape file without quotes - ") 

# input_folder = r"\\172.16.20.21\wrd_p_igbp\SCA_2000_2022\2002"

# shape_file_path = r"\\172.16.20.21\\wrd_p_igbp\\IGBP_PROJECT_2023-24\\SnowCover_Himalayas\\Himalayas\\Himalayas.shp"
...
# .apply method is being used to apply the mapping utility of shapely to retrive a 
...
# =============================================================================
# Generating a dicionary of date and snow area; one of the ways for preparing
...
# =============================================================================
df.to_csv(input_folder + "\\out.csv")
